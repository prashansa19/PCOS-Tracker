...
class PredictionHistory(models.Model):
    ...
    result = models.CharField(max_length=10, choices=[('Positive', 'Positive'),('Negative', 'Negative')], default='No Result')
    type = models.CharField(max_length=10, choices=[('General', 'General'),('Medical', 'Medical')], default='No Result')
